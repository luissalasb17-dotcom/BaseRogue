    ...
    es: {
      translation: {
        ...
        "eras": {
                ...
                "deadball_d1": "T1 (2+): +4 CON/K-AVD al equipo; sencillos (1B) hacen +8 daño extra",
                "deadball_d2": "T2 (4+): +8 CON/K-AVD; sencillos hacen +14 daño extra",
                "deadball_d3": "T3 (6+): +12 CON/K-AVD; sencillos +20 daño; carreras anotadas hacen +12 daño extra",
                "deadball_d4": "T4 (8+): +16 CON/K-AVD; sencillos +28 daño; carreras anotadas hacen +20 daño extra",
                "golden_d1": "T1 (2+): +5 PWR al equipo; todos los hits hacen +6 daño extra",
                "golden_d2": "T2 (4+): +9 PWR; hits +12 daño; 40% prob. de convertir 2B en 3B",
                "golden_d3": "T3 (6+): +14 PWR; hits +18 daño; 50% de 2B→3B y 25% de 3B→HR",
                "golden_d4": "T4 (8+): +18 PWR; hits +24 daño; 60% de 2B→3B y 40% de 3B→HR",
                "integration_d1": "T1 (2+): Equipo obtiene +2 a todos sus stats en combate",
                "integration_d2": "T2 (4+): Equipo +4 stats; outs curan +5 Stamina a todos",
                "integration_d3": "T3 (6+): Equipo +6 stats; outs curan +10 Stamina a todos",
                "integration_d4": "T4 (8+): +8 stats; outs curan +15; inmune a pérdida de Stamina",
                "speed_d1": "T1 (2+): +5 SPD al equipo; +20% prob. de robo; robo cura +10 Stamina y +8 daño",
                "speed_d2": "T2 (4+): +10 SPD y +4 EYE; +35% prob. de robo; robo cura +15 y hace +15 daño",
                "speed_d3": "T3 (6+): +14 SPD y +8 EYE; +50% prob. de robo; robo cura +20 y hace +22 daño",
                "speed_d4": "T4 (8+): +18 SPD y +12 EYE; robo 100% garantizado; cura +25 y hace +30 daño",
                "astroturf_d1": "T1 (2+): +6 DEF y +6 SPD al equipo (+10 Escudo); robos hacen +10 daño",
                "astroturf_d2": "T2 (4+): +12 DEF/SPD (+20 Escudo); robos hacen +18 daño y debuff 3 impactos",
                "astroturf_d3": "T3 (6+): +18 DEF/SPD (+30 Escudo); robos hacen +26 daño y debuff 4 impactos",
                "astroturf_d4": "T4 (8+): +24 DEF/SPD (+40 Escudo); robos +35 daño, debuff 5 impactos y outs hacen -50% daño",
                "steroid_d1": "T1 (2+): +6 PWR al equipo; Jonrones (HR) hacen +15 daño adicional",
                "steroid_d2": "T2 (4+): +12 PWR; HR hacen +25 daño adicional y curan +10 Stamina a todos",
                "steroid_d3": "T3 (6+): +18 PWR; HR hacen +38 daño adicional y curan +15 Stamina a todos",
                "steroid_d4": "T4 (8+): +25 PWR; HR hacen +50 daño adicional y curan +20 Stamina a todos",
                ...
                "tto_d1": "T1 (2+): +5 EYE y +5 PWR; BB hacen +12 daño; Ponche hace -50% daño al equipo",
                "tto_d2": "T2 (4+): +10 EYE/PWR; BB +18 daño; Ponche no incrementa racha enemiga",
                "tto_d3": "T3 (6+): +15 EYE/PWR; BB +25 daño; HR aplica debuff de 3 impactos (+30% daño)",
                "tto_d4": "T4 (8+): +20 EYE/PWR; BB +35 daño; Ponche hace 0 daño al equipo (anulado)",
    ...
    en: {
      translation: {
        ...
        "eras": {
                ...
                "deadball_d1": "T1 (2+): +4 CON/K-AVD to team; singles (1B) deal +8 extra dmg",
                "deadball_d2": "T2 (4+): +8 CON/K-AVD; singles deal +14 extra dmg",
                "deadball_d3": "T3 (6+): +12 CON/K-AVD; singles +20 dmg; runs scored deal +12 extra impact dmg",
                "deadball_d4": "T4 (8+): +16 CON/K-AVD; singles +28 dmg; runs scored deal +20 extra impact dmg",
                "golden_d1": "T1 (2+): +5 PWR to team; all hits deal +6 extra dmg",
                "golden_d2": "T2 (4+): +9 PWR; hits +12 dmg; 40% chance 2B→3B",
                "golden_d3": "T3 (6+): +14 PWR; hits +18 dmg; 50% 2B→3B and 25% 3B→HR",
                "golden_d4": "T4 (8+): +18 PWR; hits +24 dmg; 60% 2B→3B and 40% 3B→HR",
                "integration_d1": "T1 (2+): Team gains +2 to all stats in combat",
                "integration_d2": "T2 (4+): Team +4 stats; outs restore +5 Stamina to all",
                "integration_d3": "T3 (6+): Team +6 stats; outs restore +10 Stamina to all",
                "integration_d4": "T4 (8+): +8 stats; outs restore +15; immune to Stamina loss",
                "speed_d1": "T1 (2+): +5 SPD to team; +20% steal chance; steal heals +10 Stamina and +8 dmg",
                "speed_d2": "T2 (4+): +10 SPD & +4 EYE; +35% steal chance; steal heals +15 and deals +15 dmg",
                "speed_d3": "T3 (6+): +14 SPD & +8 EYE; +50% steal chance; steal heals +20 and deals +22 dmg",
                "speed_d4": "T4 (8+): +18 SPD & +12 EYE; 100% guaranteed steal; heals +25 and deals +30 dmg",
                "astroturf_d1": "T1 (2+): +6 DEF and +6 SPD to team (+10 Shield); steals deal +10 dmg",
                "astroturf_d2": "T2 (4+): +12 DEF/SPD (+20 Shield); steals deal +18 dmg & 3-impact debuff",
                "astroturf_d3": "T3 (6+): +18 DEF/SPD (+30 Shield); steals deal +26 dmg & 4-impact debuff",
                "astroturf_d4": "T4 (8+): +24 DEF/SPD (+40 Shield); steals +35 dmg, 5-impact debuff & outs deal -50% dmg",
                "steroid_d1": "T1 (2+): +6 PWR to team; Home Runs (HR) deal +15 additional dmg",
                "steroid_d2": "T2 (4+): +12 PWR; HR deal +25 additional dmg and heal +10 Stamina to all",
                "steroid_d3": "T3 (6+): +18 PWR; HR deal +38 additional dmg and heal +15 Stamina to all",
                "steroid_d4": "T4 (8+): +25 PWR; HR deal +50 additional dmg and heal +20 Stamina to all",
                ...
                "tto_d1": "T1 (2+): +5 EYE and +5 PWR; BB deal +12 dmg; Strikeout deals -50% team dmg",
                "tto_d2": "T2 (4+): +10 EYE/PWR; BB +18 dmg; Strikeouts don't grow enemy streak",
                "tto_d3": "T3 (6+): +15 EYE/PWR; BB +25 dmg; HR inflicts 3-impact debuff (+30% dmg)",
                "tto_d4": "T4 (8+): +20 EYE/PWR; BB +35 dmg; Strikeouts deal 0 damage to team (nullified)",
