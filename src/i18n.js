  ...
  const resources = {
    es: {
      ...
      "combat_info": {
            ...
            "defense": "<strong style=\"color: #38bdf8;\">🛡️ DUELO DEFENSIVO (Baja de Entrada):</strong><div style=\"font-size: 8.5px; color: #cbd5e1; margin-top: 2px;\">🛡️ Regular: <strong style=\"color:#4ade80;\">+30 HP & +15 Escudo</strong> (Fallo: -18 HP)<br>⚡ De Lujo: <strong style=\"color:#4ade80;\">+50 HP & +30 Escudo</strong> (Fallo: -25 HP)<br>💀 En Extra Innings: ¡Cualquier fallo = Walk-Off rival!</div>",
    ...
    en: {
      ...
      "combat_info": {
            ...
            "defense": "<strong style=\"color: #38bdf8;\">🛡️ DEFENSIVE DUEL (Bottom of the Inning):</strong><div style=\"font-size: 8.5px; color: #cbd5e1; margin-top: 2px;\">🛡️ Safe: <strong style=\"color:#4ade80;\">+30 HP & +15 Shield</strong> (Fail: -18 HP)<br>⚡ Clutch: <strong style=\"color:#4ade80;\">+50 HP & +30 Shield</strong> (Fail: -25 HP)<br>💀 In Extra Innings: Any error = Walk-Off Defeat!</div>",
