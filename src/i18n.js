(function () {
  ...
  const locales = {
    ...
    "combat_info": {
        ...
        "so": "<strong style=\"color: #ef4444;\">💨 PONCHE (SO):</strong> Daño directo a HP (ignora escudo).<div style=\"font-size: 8.5px; color: #a855f7; margin-top: 2px;\">🔥 Racha: 1º (-20) • 2º (-26) • 3º+ (-32 HP)<br>⚡ Extras: 1º (-30) • 2º (-36) • 3º+ (-42 HP)</div>",
    ...
    "combat_info": {
        ...
        "so": "<strong style=\"color: #ef4444;\">💨 STRIKEOUT (SO):</strong> Direct HP damage (bypasses shield).<div style=\"font-size: 8.5px; color: #a855f7; margin-top: 2px;\">🔥 Streak: 1st (-20) • 2nd (-26) • 3rd+ (-32 HP)<br>⚡ Extras: 1st (-30) • 2nd (-36) • 3rd+ (-42 HP)</div>",
