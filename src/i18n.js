    ...
    es: {
      translation: {
        ...
        "mode_select": {
                ...
                "career_desc": "Elegí un rookie y llevá su carrera temporada a temporada, año real por año real, hasta el retiro. ¿Va a alcanzar su potencial... o va a quedar corto?",
                "career_btn": "🏆 EMPEZAR CARRERA"
        },
        "career": {
                "difficulty_title": "🏆 ELEGÍ LA DIFICULTAD",
                ...
                "hub_next_note": "Guardado. La simulación temporada a temporada se sigue construyendo — por ahora podés ver tu rookie y su punto de partida.",
                ...
                "leaderboard_title": "VOS vs. NIVEL MVP DE LA LIGA",
                "mvp_level": "nivel MVP",
                ...
                "event_training_prompt": "Antes de arrancar la temporada, ¿cómo te preparás?",
                ...
                "event_slump_prompt": "Llevás unas semanas irregulares. ¿Cómo lo manejás?",
                ...
                "contract_prompt": "¿Te quedás en tu equipo o firmás en otro lado?",
                ...
                "winter_prompt": "¿Jugás la liga invernal antes de la próxima temporada? Podés mejorar, pero hay riesgo de lesión.",
                ...
                "role_starter_desc": "Más turnos, más presión — crecés más rápido",
                ...
                "contract_auto_renew": "Seguís bajo contrato",
        ...
        "gamble": {
                "budget": {
                        "title": "Todo o Nada",
                        "desc": "Apostás TODO tu presupuesto actual a un tiro de dado. Si ganás, se duplica. Si perdés, lo perdés todo."
                },
                "trade": {
                        "title": "Intercambio a Ciegas",
                        "desc": "Cambiás a tu jugador titular más débil por una oferta a ciegas. Si ganás, el reemplazo es de rareza SUPERIOR garantizada. Si perdés, el reemplazo es Common y esa posición queda bloqueada para draft por 2 nodos."
                },
                "synergy": {
                        "title": "Sinergia Prohibida",
                        "desc": "Elegí un jugador de tu roster: si ganás, cuenta x4 para la sinergia de su Era. Si perdés, 2 jugadores al azar de tu roster pierden la elegibilidad de Era por el resto de la run."
                },
                "scout": {
                        "title": "Cazatalentos Misterioso",
                        "desc": "Un cazatalentos ofrece una carta Legendary para tu posición más débil. Si ganás, la firmás gratis. Si perdés, tu mejor jugador se lesiona: -20 en todas sus stats por el resto de la run."
                }
        },
        "sign": {
