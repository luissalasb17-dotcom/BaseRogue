(function () {
  ...
  const locales = {
    ...
    "eras": {
        ...
        "integration_d1": "T1 (2+): +2 a todos los stats; hits hacen +4 daño extra",
        "integration_d2": "T2 (4+): +4 a todos los stats; hits +8 daño y reparan +10 Escudo al inicio de cada inning",
        "integration_d3": "T3 (6+): +7 a todos los stats; hits +14 daño y reparan +15 Escudo al inicio de cada inning",
        "integration_d4": "T4 (8+): +10 a todos los stats; hits +20 daño, reparan +25 Escudo al inicio de cada inning y la stat más baja de cada bateador se iguala a su stat más alta",
        ...
        "astroturf_d1": "T1 (2+): +2 DEF y +2 SPD al equipo (+10 Escudo inicial y repara +5 Escudo cada entrada)",
        "astroturf_d2": "T2 (4+): +5 DEF/SPD (+20 Escudo inicial y repara +10 Escudo); robos infligen +10 daño directo al pitcher",
        "astroturf_d3": "T3 (6+): +8 DEF/SPD (+30 Escudo inicial y repara +15 Escudo); robos infligen +15 daño directo al pitcher",
        "astroturf_d4": "T4 (8+): +12 DEF/SPD (+40 Escudo inicial y repara +20 Escudo); robos infligen +25 daño directo y outs normales hacen -50% daño",
    ...
    "map": {
        ...
        "zone_opening": "Entrenamiento & Mes de Apertura",
        "zone_allstar": "Días de Verano & All-Star Game",
        "zone_pennant": "Caza del Banderín de Septiembre",
        "zone_playoffs": "Postemporada: Serie Mundial",
        "stage_opening": "Abril: Inicio de temporada - Dificultad: Normal",
        "stage_allstar": "Junio–Julio: Mitad de temporada - Dificultad: Difícil",
        "stage_pennant": "Septiembre: Recta final - Dificultad: Experto",
        "stage_playoffs": "Octubre: Fase final - Dificultad: Leyenda",
        "locked": "BLOQUEADA",
        "active": "ACTIVA",
    ...
    "mode_select": {
        ...
        "dynasty_title": "MODO DINASTÍA",
        "dynasty_subtitle": "HOBBY BOX & CONTRATOS",
        "dynasty_desc": "Abre una caja de 25 sobres retro para armar tu plantilla. Administra contratos de 1 a 10 temporadas, traspasos y compite en 162 juegos.",
        "dynasty_btn": "📦 EMPEZAR DINASTÍA"
    },
    "common": {
        "back_menu": "← MENÚ",
        "damage": "DAÑO",
    ...
    "dex": {
        ...
        "search_placeholder_shortlist": "Buscar en shortlist por nombre, equipo, era o rol...",
        "btn_random_player": "🎲 CARTA RANDOM",
        "btn_next_pack": "📦 OTRO SOBRE",
        "btn_bbref": "B-REF ↗",
        "btn_shortlist_add": "⭐ GUARDAR EN SHORTLIST",
        "btn_shortlist_remove": "★ QUITAR DE SHORTLIST",
        "shortlist_added_msg": "Jugador guardado en Shortlist",
        "shortlist_removed_msg": "Jugador quitado de Shortlist",
        "shortlist_empty": "Tu Shortlist está vacía. ¡Haz clic en cualquier carta y selecciona ⭐ GUARDAR EN SHORTLIST para marcar a tus jugadores favoritos!",
        "pos_label": "POS:",
        "role_label": "ROL:",
        "pos_all": "TODOS",
        "era_all": "TODOS",
    ...
    "pre_fight": {
        ...
        "clash_contact": "Contacto",
        "clash_power": "Poder",
        "clash_eye": "Ojo / BB",
        "clash_k": "Anti-K",
        "tip_hitter": "💡 Luz verde: Tu bateador tiene ventaja táctica para castigar al lanzador.",
        "tip_pitcher": "⚠️ Precaución: El lanzador domina la zona. Peligro de ponche o contacto débil.",
        "tip_even": "⚖️ Duelo cerrado: La tirada de dados y el timing definirán el turno."
    },
    "training": {
    ...
    "match": {
        ...
        "extra_innings_hud_desc": "Outs: -30 HP • Ks: 30/38/45 HP • ¡Fallo en la baja = Walk-Off!",
    ...
    "challenge162": {
        ...
        "mono_team_desc": "Compite exclusivamente con peloteros que vistieron la camiseta de una única franquicia de Grandes Ligas.",
        "play_with_team": "JUGAR CON {{code}}",
        "select_franchise_btn": "ELEGIR EQUIPO ▶",
        "franchise_select_title": "DESAFÍO MONO-TEAM (FRANQUICIAS MLB)",
        "franchise_select_desc": "Elige una franquicia de MLB. Tu roster completo de 17 peloteros se construirá exclusivamente con estrellas y leyendas que defendieron sus colores. Necesitas al menos 17 cartas desbloqueadas para jugar.",
        "mono_era_badge": "EPOCA HISTORICA",
        "mono_era_title": "DESAFIO MONO-ERA",
        "mono_era_desc": "Viaja en el tiempo y compite únicamente con las estrellas de una de las 9 eras doradas del béisbol.",
        "play_with_era": "JUGAR {{era}}",
        "select_era_btn": "ELEGIR ERA ▶",
        "era_select_title": "DESAFÍO MONO-ERA (ERAS HISTÓRICAS)",
        "era_select_desc": "Viaja en el tiempo y juega exclusivamente con figuras de una época histórica del béisbol. Tu roster se armará únicamente con cartas de esa era. Necesitas al menos 17 cartas desbloqueadas para jugar.",
        "back_to_hub": "← VOLVER AL HUB",
        "cleared_tag": "CAMPEÓN WS",
        "ready_tag": "LISTO",
        "locked_tag": "BLOQUEADO",
        "search_franchise": "🔍 Buscar franquicia (ej. Yankees, Dodgers, Boston...)",
        "franchises_ready_count": "{{ready}} / {{total}} Equipos Listos",
        "eras_ready_count": "{{ready}} / {{total}} Eras Listas",
        "need_cards_warning": "Se requieren al menos 17 cartas para este modo (tienes {{count}}). ¡Gana partidas rápidas para desbloquear más!",
        "hub_packs_chip": "✨ 25 SOBRES: 14 BATEADORES + 11 LANZADORES",
        "hub_allstar_chip": "💎 COLECCIÓN TOTAL SIN RESTRICCIONES",
        "franchises_ready_chip": "🟢 {{ready}}/{{total}} EQUIPOS LISTOS",
        "eras_ready_chip": "🟢 {{ready}}/{{total}} ERAS LISTAS",
        "cards_label": "CARTAS",
        "need_more_count": "FALTAN {{count}}",
        "play_btn": "JUGAR ▶",
        "franchises_cleared_summary": "🏆 {{cleared}} / {{total}} Franquicias Campeonas",
        "franchises_ready_summary": "🟢 {{ready}} / {{total}} Equipos con Roster Listo (17+ cartas)",
        "eras_cleared_summary": "🏆 {{cleared}} / {{total}} Eras Campeonas",
        "eras_ready_summary": "🟢 {{ready}} / {{total}} Eras con Roster Listo (17+ cartas)",
        "packs_draft_stage": "HOBBY PACKS DRAFT: {{box}} (SOBRE {{pack}} DE {{total}})",
        "box_batters": "CAJA DE BATEADORES",
        "box_pitchers": "CAJA DE LANZADORES",
        "deck_title": "DECK DE CARTAS DEL EQUIPO",
        "deck_counts": "{{b}}/14 Bateadores • {{p}}/11 Lanzadores",
        "drafted_badge": "DRAFTEADO AL ROSTER 162-0",
        "placed_in_deck": "Carta colocada en tu deck",
        "flip_card_btn": "VOLTEAR CARTA",
        "click_to_flip": "Clic para voltear carta",
        "open_next_pack": "📦 ABRIR SIGUIENTE SOBRE ({{pack}}/25) ➔",
        "open_pitchers_box": "⚾ ABRIR CAJA DE LANZADORES ➔",
        "finalize_roster": "🚀 FINALIZAR ROSTER Y EMPEZAR 162-0 ➔",
        "pack_transition_title": "¡CAJA DE BATEADORES COMPLETADA!",
        "pack_transition_desc": "Tu alineación titular de <strong>9 bateadores</strong> y tus <strong>5 jugadores en la banca</strong> están listos. Ahora abre la <strong>Caja de Lanzadores (11 Sobres)</strong> para draftear tu rotación de 5 abridores (SP1-SP5) y tu bullpen de 6 relevistas (Closer, Setup y 4 Relevos Medios).",
        "pack_transition_box2": "📦 CAJA #2: LANZADORES HOBBY BOX (11 SOBRES)",
        "pack_transition_box2_sub": "5 Abridores (SP) + 6 Brazos de Bullpen (CL, SU, RP1-RP4)",
        "pack_transition_btn": "📦 ABRIR CAJA DE LANZADORES (11 SOBRES) ➔",
        "pack_cancel_confirm": "¿Deseas cancelar el draft de sobres y volver al menú?",
        "cancel": "CANCELAR",
        "rotation_title_5": "ROTACION DE ABRIDORES (ROTATION - 5 CARTAS)",
        "bullpen_title_6": "CUERPO DE RELEVISTAS (BULLPEN - 6 CARTAS)",
        "pitchers_box_subtitle": "5 Abridores (SP) + 6 Relevistas",
        "batters_box_subtitle": "9 Titulares + 5 de Banca",
        "card_click_attributes": "🔄 CLIC PARA VER ATRIBUTOS",
        "draft_trading_card": "🎴 CARTA DE DRAFT",
        "pack_tap_rip": "¡TOCA EL SOBRE PARA ABRIRLO!",
        "pack_rip_prompt": "✨ TOCA EL SOBRE PARA ABRIRLO ✨",
        "pack_num_indicator": "SOBRE {{current}} / {{total}}",
        "pack_sealed_foil": "SOBRE HOBBY RETRO SELLADO",
        "pack_click_to_reveal": "Haz clic en el sobre para rasgar el envoltorio y revelar tu carta",
        ...
        "ring_of_champions": "💍 PLANTILLA DE {{count}} CAMPEONES (ROSTER COMPLETO)",
    ...
    "combat_info": {
        ...
        "out": "<strong style=\"color: #9ca3af;\">✋ OUT (Fly/Ground):</strong> <span style=\"color:#ef4444;font-weight:bold;\">-20 HP</span> al Escudo (el sobrante daña HP). Extras: <span style=\"color:#ef4444;font-weight:bold;\">-30 HP</span>.",
        "so": "<strong style=\"color: #ef4444;\">💨 PONCHE (SO):</strong> Daño directo a HP (ignora escudo).<div style=\"font-size: 8.5px; color: #a855f7; margin-top: 2px;\">🔥 Racha: 1º (-20) • 2º (-25) • 3º+ (-30 HP)<br>⚡ Extras: 1º (-30) • 2º (-38) • 3º+ (-45 HP)</div>",
        "pitcher_title": "⚾ DAÑO AL LANZADOR RIVAL:",
        "bb": "🚶 BB: <b style=\"color:#3b82f6;\">15 HP</b> <span style=\"font-size:8px;color:#38bdf8;\">(+20% daño 1 turno)</span>",
        "single": "✅ 1B: <b style=\"color:#a7f3d0;\">20 HP</b>",
        "double": "⚡ 2B: <b style=\"color:#10b981;\">35 HP</b>",
        "triple": "🔥 3B: <b style=\"color:#06b6d4;\">50 HP</b>",
        "hr": "🚀 <strong>HR:</strong> <b style=\"color:#eab308;\">75 HP base</b>",
    ...
    "extra_modal": {
        ...
        "rule2_desc": "Los ponches directos a la vida aumentan a 30 / 38 / 45 HP en racha.",
    ...
    "select_desc": "Selecciona tu franquicia. Recibirás una Hobby Box de 25 sobres coleccionables para abrir uno a uno y conformar tu Roster oficial de 25 jugadores con contratos multianuales.",
    "open_box_btn": "ABRIR HOBBY BOX (25 SOBRES) ➔",
    "back_menu": "← MENÚ",
    "american_league": "LIGA AMERICANA (AL)",
    "national_league": "LIGA NACIONAL (NL)",
    "east": "Este",
    "central": "Central",
    "west": "Oeste",
    "pack_progress": "SOBRE {{curr}} DE {{total}}",
    "tap_to_flip": "🔄 TOCA PARA FLIP",
    "ovr_rating": "OVR RATING",
    "career_stats_header": "ESTADÍSTICAS DE CARRERA (MLB)",
    "signed_contract": "✍️ CONTRATO FIRMADO: {{years}} AÑOS",
    "next_pack_btn": "📦 ABRIR SIGUIENTE SOBRE ({{next}}/{{total}}) ➔",
    "view_roster_btn": "📋 VER ROSTER COMPLETO (25 JUGADORES) ➔",
    "start_season_btn": "⚾ INICIAR TEMPORADA REGULAR (162 JUEGOS) ➔",
    "sim_1": "▶ SIMULAR 1",
    "sim_10": "⏩ SIMULAR 10",
    "sim_event": "🎯 AL SIGUIENTE EVENTO",
    "roster_contracts": "📋 ROSTER & CONTRATOS",
    "standings": "TABLA DE POSICIONES",
    "team_stats": "📊 ESTADÍSTICAS DEL EQUIPO",
    "league_leaders": "🏅 LÍDERES DE LA LIGA",
    "view_opponents": "🔍 VER RIVALES",
    "reset_dynasty": "🗑️ REINICIAR DINASTÍA",
    "reset_confirm": "¿Estás seguro de reiniciar tu dinastía? Perderás todo tu progreso actual.",
    "streak_hot": "🔥 EN RACHA: {{count}} VICTORIAS (BUFF +{{buff}} CONTACTO)",
    "streak_cold": "❄️ SLUMP: {{count}} DERROTAS (PENALIDAD)",
    "lineup_title": "⚡ LINEUP TITULAR (9 BATEADORES)",
    "rotation_title": "🧢 ROTACIÓN DE ABRIDORES (5 SP)",
    "bullpen_title": "🔥 BULLPEN & CERRADOR (7 RP)",
    "bench_title": "🛋️ BANCA DE SUPLENTES (4 JUGADORES)",
    "season_leaders_title": "🏅 LÍDERES DE LA LIGA (TEMPORADA {{year}})",
    "career_leaders_title": "🏛️ LÍDERES HISTÓRICOS DE TU DINASTÍA",
    "playoffs_btn": "🏆 IR A POSTEMPORADA ➔",
    "offseason_title": "🏁 FIN DE LA TEMPORADA {{year}}",
    "expired_contracts_title": "⚠️ CONTRATOS EXPIRADOS (AGENCIA LIBRE):",
    "next_year_btn": "🌅 ARRANCAR TEMPORADA {{year}} ➔",
    "reinforcement_title": "JUEGO 40: REFUERZO DE PRIMAVERA",
    "reinforcement_desc": "¡Tu directiva te entrega 1 Sobre Especial de Refuerzo para apuntalar tu plantilla!",
    "open_reinforcement_pack": "✨ ABRIR SOBRE DE REFUERZO ➔",
    "replace_player_title": "🔄 SELECCIONA EL JUGADOR A REEMPLAZAR",
    "replace_player_desc": "El jugador seleccionado causará baja inmediata de tu franquicia y el nuevo refuerzo ocupará su lugar con un contrato de 2 temporadas.",
    "keep_current_roster": "❌ CONSERVAR ROSTER ACTUAL (DESCARTAR REFUERZO)",
    "replace_btn": "REEMPLAZAR",
    "replaced_success": "¡Se ha incorporado {{newPlayer}} en sustitución de {{oldPlayer}}!",
    "empty_slot": "[Vacío]",
    "selected_franchise_banner": "FRANQUICIA: {{team}} ({{league}} {{div}})",
    "roster_forming_title": "📋 ROSTER EN FORMACIÓN ({{count}}/25)",
    "bat_pitch_count": "{{bat}} Bat • {{pitch}} Pitch",
    "lineup_forming": "⚡ LINEUP (9 TITULARES)",
    "bench_forming": "🛋️ BANCA ({{count}}/4)",
    "rotation_forming": "🧢 ROTACIÓN (5 SP)",
    "bullpen_forming": "🔥 BULLPEN (7 RP)",
    "official_roster_title": "📋 ROSTER OFICIAL DE 25: {{icon}} {{name}}",
    "official_roster_subtitle": "Temporada {{year}} • Contratos multianuales vigentes",
    "season_header": "⚾ TEMPORADA {{year}}: {{icon}} {{name}}",
    "season_record_summary": "Récord: <strong style=\"color:#34d399;\">{{w}}W</strong> - <strong style=\"color:#f87171;\">{{l}}L</strong> • {{league}} {{div}} ({{played}}/162 juegos) • Anillos: 🏆 {{rings}}",
    "day_timeline_start": "DÍA 1",
    "day_timeline_40": "DÍA 40 (REFUERZO)",
    "day_timeline_81": "DÍA 81 (ALL-STAR)",
    "day_timeline_110": "DÍA 110 (TRADE DEADLINE)",
    "day_timeline_end": "DÍA 162",
    "recent_results_title": "📜 ÚLTIMOS RESULTADOS",
    "no_games_yet": "Aún no se han disputado partidos.",
    "team_header_col": "EQUIPO",
    "diff_header_col": "DIF",
    "batter_stats_header": "⚡ ESTADÍSTICAS DE BATEADORES ({{icon}} {{name}})",
    "pitcher_stats_header": "🧢 ESTADÍSTICAS DE LANZADORES ({{icon}} {{name}})",
    "no_at_bats": "Sin turnos al bate disputados todavía.",
    "no_innings_pitched": "Sin innings lanzados todavía.",
    "other_teams_title": "🔍 ROSTERS DE LAS OTRAS 29 FRANQUICIAS DE LA LIGA",
    "ace_label": "Ace",
    "best_bat_label": "Bate",
    "rival_alert_details": "⚾ {{icon}} {{name}}\n\nLíder de Lineup: {{lineup}}\nAbridor As: {{sp}}\nCerrador: {{rp}}\nTotal Jugadores: 25 en plantilla activa.",
    "midseason_allstar_title": "JUEGO 81: ALL-STAR BREAK",
    "midseason_allstar_desc": "¡Mitad de temporada regular cumplida! El equipo descansa, se recargan energías y arranca la lucha por el título.",
    "midseason_allstar_btn": "CONTINUAR SEGUNDA MITAD ➔",
    "midseason_trade_title": "JUEGO 110: TRADE DEADLINE",
    "midseason_trade_desc": "Otro club ofrece a la estrella <strong>{{name}} (OVR {{ovr}})</strong> para tu recta final.",
    "midseason_trade_question": "¿Deseas aceptar el canje para reforzar tu alineación hacia los Playoffs?",
    "midseason_trade_accept": "🤝 ACEPTAR TRASPASO",
    "midseason_trade_decline": "MANTENER ROSTER",
    "spring_booster_title": "SPRING BOOSTER PACK",
    "spring_booster_badge": "REFUERZO DE FRANQUICIA (2 AÑOS)",
    "spring_booster_open": "✨ TOCA PARA ABRIR REFUERZO ✨",
    "card_career_saves": "SALVADOS (SV)",
    "card_career_strikeouts": "PONCHES (K)",
    "card_career_record": "RÉCORD (W-L)",
    "card_career_innings": "INNINGS (IP)",
    "card_career_hits": "HITS (H)",
    "card_career_homers": "JONRONES (HR)",
    "card_career_rbis": "IMPULSADAS (RBI)",
    "playoff_won_ws": "🏆 ¡CAMPEONES DE LA SERIE MUNDIAL! Tu equipo conquistó el trofeo de comisionado.",
    "playoff_eliminated": "🥈 Eliminados en la Serie de Campeonato tras una gran batalla en Postemporada.",
    "playoff_missed": "❌ Récord de {{w}}-{{l}}: No alcanzó para clasificar a Octubre.",
    "offseason_expired_count": "{{count}} jugadores",
    "offseason_expired_desc": "Los jugadores que culminaron contrato salen a la agencia libre. <strong>¡Todos tus jugadores con contratos vigentes se mantienen en el roster!</strong> Abrirás exactamente {{count}} sobres para cubrir las vacantes.",
    "offseason_no_expired": "¡Excelente gestión! Ningún jugador ha expirado contrato este año. Tu roster se mantiene intacto.",
    "tap_open_pack_num": "✨ TOCA PARA ABRIR SOBRE #{{num}} ✨",
    "rotation_bullpen_pack": "ROTATION & BULLPEN PACK",
    "batter_pack": "MLB ALL-TIME BATTER PACK",
    "year_suffix": "AÑO",
    "years_suffix": "AÑOS",
    "leader_hr": "JONRONES (HR)",
    "leader_rbi": "IMPULSADAS (RBI)",
    "leader_avg": "PROMEDIO (AVG)",
    "leader_k": "PONCHES (K)",
    "leader_w": "VICTORIAS (W)",
    "leader_era": "EFECTIVIDAD (ERA)",
    "contract_multi": "Acuerdo multianual de franquicia",
    "contract_mega": "¡Mega contrato de franquicia!",
    "contract_short": "Contrato corto de prueba (Mala suerte)",
    "contract_surprise": "¡Apuesta de futuro sorpresa!",
    "batting_order_hint": "Orden de Bateo (Arrastra y suelta para reordenar)",
    "optimal_order_btn": "⚡ ORDEN ÓPTIMO",
    "player_details_modal_title": "FICHA DE JUGADOR & ESTADÍSTICAS",
    "season_stats_header": "TEMPORADA ACTUAL",
    "career_dynasty_stats_header": "TOTAL ACUMULADO DINASTÍA",
    "rival_roster_modal_title": "ROSTER OFICIAL DE 25: {{team}}",
    "close": "CERRAR",
    "click_player_hint": "💡 Toca a cualquier jugador para ver su carta y estadísticas completas",
    "btn_resign_player": "✍️ OFRECER RENOVACIÓN",
    "btn_already_negotiated": "YA NEGOCIADO ESTE AÑO",
    "resign_modal_title": "OFERTA DE EXTENSIÓN DE CONTRATO",
    "resign_modal_desc": "Intenta renovar a {{name}} (OVR {{ovr}}) antes de que llegue a la agencia libre. Los jugadores evalúan el rendimiento del equipo, su nivel y los años ofrecidos. Podrían aceptar o rechazar la oferta.",
    "resign_offer_length": "Años de Contrato a Ofrecer:",
    "resign_interest_high": "Alto Interés (85% Probabilidad)",
    "resign_interest_med": "Interés Moderado (55% Probabilidad)",
    "resign_interest_low": "Negociación Difícil (30% Probabilidad)",
    "resign_submit_btn": "ENVIAR OFERTA ➔",
    "resign_success_title": "¡ACUERDO ALCANZADO! 🎉",
    "resign_success_desc": "¡{{name}} está encantado con el proyecto y firmó una extensión por {{years}} temporada(s)!",
    ...
    "eras": {
        ...
        "integration_d2": "T2 (4+): Team +4 to all stats; hits deal +8 dmg and repair +10 Shield at start of each inning",
        "integration_d3": "T3 (6+): Team +7 to all stats; hits deal +14 dmg and repair +15 Shield at start of each inning",
        "integration_d4": "T4 (8+): Team +10 all stats; hits deal +20 dmg, repair +25 Shield at start of each inning and each batter's lowest stat equals their highest stat",
        ...
        "astroturf_d1": "T1 (2+): Team +2 DEF & +2 SPD (+10 initial Shield & repairs +5 Shield each inning)",
        "astroturf_d2": "T2 (4+): +5 DEF/SPD (+20 initial Shield & repairs +10 Shield); steals deal +10 direct damage to pitcher",
        "astroturf_d3": "T3 (6+): +8 DEF/SPD (+30 initial Shield & repairs +15 Shield); steals deal +15 direct damage to pitcher",
        "astroturf_d4": "T4 (8+): +12 DEF/SPD (+40 initial Shield & repairs +20 Shield); steals deal +25 direct dmg and normal outs deal -50% dmg",
    ...
    "map": {
        ...
        "zone_opening": "Spring Training & Opening Month",
        "zone_allstar": "Summer Grind & All-Star Break",
        "zone_pennant": "September Pennant Chase",
        "zone_playoffs": "Postseason: World Series",
        "stage_opening": "April: Season Opener - Difficulty: Normal",
        "stage_allstar": "June–July: Midseason Heat - Difficulty: Hard",
        "stage_pennant": "September: Pennant Race - Difficulty: Expert",
        "stage_playoffs": "October: World Series - Difficulty: Legend",
        "locked": "LOCKED",
        "active": "ACTIVE",
        "completed": "COMPLETED",
        "node_opener": "OPENER",
    ...
    "dex": {
        ...
        "tab_opponents": "🥊 OPPONENTS (QUICK PLAY)",
        "tab_shortlist": "⭐ SHORTLIST / FAVORITES",
        "counter_legends": "Cards Discovered",
        "counter_opponents": "Opponents Faced",
        "counter_shortlist": "Shortlisted Cards",
        ...
        "search_placeholder_shortlist": "Search shortlist by name, team, era or role...",
        "btn_random_player": "🎲 RANDOM CARD",
        "btn_next_pack": "NEXT PACK",
        "btn_bbref": "B-REF ↗",
        "btn_shortlist_add": "⭐ ADD TO SHORTLIST",
        "btn_shortlist_remove": "★ REMOVE FROM SHORTLIST",
        "shortlist_added_msg": "Player added to Shortlist",
        "shortlist_removed_msg": "Player removed from Shortlist",
        "shortlist_empty": "Your shortlist is empty. Click on any card and select ⭐ ADD TO SHORTLIST to bookmark your favorite players!",
        "pos_label": "POS:",
        "role_label": "ROLE:",
        "pos_all": "ALL",
        "era_all": "ALL",
        "locked": "LOCKED",
        "load_more": "Load more",
        "challenge162_filter": "🏆 162-0 Challenge eligible only",
        "challenge162_badge_label": "🏆 162-0 CHALLENGE",
        "challenge162_badge_tooltip": "Eligible for 162-0 Challenge",
        "career_header": "CAREER STATS (MLB)",
        "hits_label": "HITS (H)",
    ...
    "pre_fight": {
        ...
        "clash_contact": "Contact",
        "clash_power": "Power",
        "clash_eye": "Eye / Walk",
        "clash_k": "Anti-K",
        "tip_hitter": "💡 Green light: Batter has superior edge to do heavy damage.",
        "tip_pitcher": "⚠️ Caution: Pitcher commands this zone. Expect strikeouts or weak contact.",
        "tip_even": "⚖️ Close battle: Execution on the dice roll will decide the turn."
    },
    "training": {
    ...
    "match": {
        ...
        "extra_innings_hud_desc": "Outs: -30 HP • Ks: 30/38/45 HP • Bottom error = Walk-Off Defeat!",
    ...
    "challenge162": {
        ...
        "mono_team_badge": "SINGLE FRANCHISE",
        "mono_team_title": "MONO-TEAM CHALLENGE",
        "mono_team_desc": "Compete exclusively with players who wore the uniform of a single MLB franchise.",
        "play_with_team": "PLAY WITH {{code}}",
        "select_franchise_btn": "SELECT TEAM ▶",
        "franchise_select_title": "MONO-TEAM CHALLENGE (MLB FRANCHISES)",
        "franchise_select_desc": "Choose an MLB franchise. Your 17-player roster will be formed exclusively from stars and legends who wore their colors. At least 17 unlocked cards are required to play.",
        ...
        "select_era_btn": "SELECT ERA ▶",
        "era_select_title": "MONO-ERA CHALLENGE (HISTORIC ERAS)",
        "era_select_desc": "Travel back in time and play strictly with legends from one of 9 historic eras. At least 17 unlocked cards are required to play.",
        "back_to_hub": "← BACK TO HUB",
        "cleared_tag": "WS CHAMPION",
        "ready_tag": "READY",
        "locked_tag": "LOCKED",
        "search_franchise": "🔍 Search franchise (e.g. Yankees, Dodgers, Boston...)",
        "franchises_ready_count": "{{ready}} / {{total}} Teams Ready",
        "eras_ready_count": "{{ready}} / {{total}} Eras Ready",
        "need_cards_warning": "Requires at least 17 cards for this mode (you have {{count}}). Win quick play runs to unlock more!",
        "hub_packs_chip": "✨ 25 PACKS: 14 BATTERS + 11 PITCHERS",
        "hub_allstar_chip": "💎 FULL UNLOCKED COLLECTION",
        "franchises_ready_chip": "🟢 {{ready}}/{{total}} TEAMS READY",
        "eras_ready_chip": "🟢 {{ready}}/{{total}} ERAS READY",
        "cards_label": "CARDS",
        "need_more_count": "NEED {{count}}",
        "play_btn": "PLAY ▶",
        "franchises_cleared_summary": "🏆 {{cleared}} / {{total}} Champion Franchises",
        "franchises_ready_summary": "🟢 {{ready}} / {{total}} Teams with Ready Roster (17+ cards)",
        "eras_cleared_summary": "🏆 {{cleared}} / {{total}} Champion Eras",
        "eras_ready_summary": "🟢 {{ready}} / {{total}} Eras with Ready Roster (17+ cards)",
        "packs_draft_stage": "HOBBY PACKS DRAFT: {{box}} (PACK {{pack}} OF {{total}})",
        "box_batters": "BATTERS BOX",
        "box_pitchers": "PITCHERS BOX",
        "deck_title": "TEAM CARD DECK",
        "deck_counts": "{{b}}/14 Batters • {{p}}/11 Pitchers",
        "drafted_badge": "DRAFTED TO 162-0 ROSTER",
        "placed_in_deck": "Card placed in your deck",
        "flip_card_btn": "FLIP CARD",
        "click_to_flip": "Click to flip card",
        "open_next_pack": "📦 OPEN NEXT PACK ({{pack}}/25) ➔",
        "open_pitchers_box": "⚾ OPEN PITCHERS BOX ➔",
        "finalize_roster": "🚀 FINALIZE ROSTER & START 162-0 ➔",
        "pack_transition_title": "BATTERS BOX COMPLETED!",
        "pack_transition_desc": "Your starting lineup of <strong>9 batters</strong> and <strong>5 bench players</strong> are set. Now open the <strong>Pitchers Box (11 Packs)</strong> to draft your 5-man starting rotation (SP1-SP5) and 6-man bullpen (Closer, Setup, and 4 Middle Relievers).",
        "pack_transition_box2": "📦 BOX #2: PITCHERS HOBBY BOX (11 PACKS)",
        "pack_transition_box2_sub": "5 Starters (SP) + 6 Bullpen Arms (CL, SU, RP1-RP4)",
        "pack_transition_btn": "📦 OPEN PITCHERS BOX (11 PACKS) ➔",
        "pack_cancel_confirm": "Do you want to cancel the packs draft and return to the menu?",
        "cancel": "CANCEL",
        "rotation_title_5": "STARTING ROTATION (ROTATION - 5 CARDS)",
        "bullpen_title_6": "BULLPEN RELIEVERS (BULLPEN - 6 CARDS)",
        "pitchers_box_subtitle": "5 Starters (SP) + 6 Relievers",
        "batters_box_subtitle": "9 Starters + 5 Bench",
        "card_click_attributes": "🔄 CLICK TO VIEW ATTRIBUTES",
        "draft_trading_card": "🎴 DRAFT TRADING CARD",
        "pack_tap_rip": "TAP THE PACK TO RIP OPEN!",
        "pack_rip_prompt": "✨ TAP PACK TO RIP OPEN ✨",
        "pack_num_indicator": "PACK {{current}} / {{total}}",
        "pack_sealed_foil": "SEALED RETRO HOBBY PACK",
        "pack_click_to_reveal": "Click on the pack foil to rip it open and reveal your card",
        ...
        "ring_of_champions": "💍 RING OF {{count}} CHAMPIONS (FULL ROSTER)",
    ...
    "combat_info": {
        ...
        "out": "<strong style=\"color: #9ca3af;\">✋ OUT (Fly/Ground):</strong> <span style=\"color:#ef4444;font-weight:bold;\">-20 HP</span> to Shield (overflow hits HP). Extras: <span style=\"color:#ef4444;font-weight:bold;\">-30 HP</span>.",
        "so": "<strong style=\"color: #ef4444;\">💨 STRIKEOUT (SO):</strong> Direct HP damage (bypasses shield).<div style=\"font-size: 8.5px; color: #a855f7; margin-top: 2px;\">🔥 Streak: 1st (-20) • 2nd (-25) • 3rd+ (-30 HP)<br>⚡ Extras: 1st (-30) • 2nd (-38) • 3rd+ (-45 HP)</div>",
        "pitcher_title": "⚾ RIVAL PITCHER DAMAGE:",
        "bb": "🚶 BB: <b style=\"color:#3b82f6;\">15 HP</b> <span style=\"font-size:8px;color:#38bdf8;\">(+20% damage 1 turn)</span>",
        "single": "✅ 1B: <b style=\"color:#a7f3d0;\">20 HP</b>",
        "double": "⚡ 2B: <b style=\"color:#10b981;\">35 HP</b>",
        "triple": "🔥 3B: <b style=\"color:#06b6d4;\">50 HP</b>",
        "hr": "🚀 <strong>HR:</strong> <b style=\"color:#eab308;\">75 HP base</b>",
    ...
    "extra_modal": {
        ...
        "rule2_desc": "Direct strikeout damage increases to 30 / 38 / 45 HP in streak.",
    ...
    "select_desc": "Pick your franchise. You will receive a 25-pack Hobby Box to open pack-by-pack, drafting your official 25-man roster with multi-year contracts.",
    "open_box_btn": "OPEN HOBBY BOX (25 PACKS) ➔",
    "back_menu": "← MENU",
    "american_league": "AMERICAN LEAGUE (AL)",
    "national_league": "NATIONAL LEAGUE (NL)",
    "east": "East",
    "central": "Central",
    "west": "West",
    "pack_progress": "PACK {{curr}} OF {{total}}",
    "tap_to_flip": "🔄 TAP TO FLIP",
    "ovr_rating": "OVR RATING",
    "career_stats_header": "CAREER STATS (MLB)",
    "signed_contract": "✍️ SIGNED CONTRACT: {{years}} YEARS",
    "next_pack_btn": "📦 OPEN NEXT PACK ({{next}}/{{total}}) ➔",
    "view_roster_btn": "📋 VIEW FULL ROSTER (25 PLAYERS) ➔",
    "start_season_btn": "⚾ START REGULAR SEASON (162 GAMES) ➔",
    "sim_1": "▶ SIMULATE 1",
    "sim_10": "⏩ SIMULATE 10",
    "sim_event": "🎯 TO NEXT EVENT",
    "roster_contracts": "📋 ROSTER & CONTRACTS",
    "standings": "STANDINGS",
    "team_stats": "📊 TEAM STATS",
    "league_leaders": "🏅 LEAGUE LEADERS",
    "view_opponents": "🔍 VIEW RIVALS",
    "reset_dynasty": "🗑️ RESET DYNASTY",
    "reset_confirm": "Are you sure you want to reset your dynasty? All current progress will be wiped.",
    "streak_hot": "🔥 ON FIRE: {{count}} WINS (BUFF +{{buff}} CONTACT)",
    "streak_cold": "❄️ SLUMP: {{count}} LOSSES (PENALTY)",
    "lineup_title": "⚡ STARTING LINEUP (9 BATTERS)",
    "rotation_title": "🧢 STARTING ROTATION (5 SP)",
    "bullpen_title": "🔥 BULLPEN & CLOSER (7 RP)",
    "bench_title": "🛋️ BENCH (4 RESERVES)",
    "season_leaders_title": "🏅 LEAGUE LEADERS (SEASON {{year}})",
    "career_leaders_title": "🏛️ HISTORIC DYNASTY LEADERS",
    "playoffs_btn": "🏆 ADVANCE TO POSTSEASON ➔",
    "offseason_title": "🏁 END OF SEASON {{year}}",
    "expired_contracts_title": "⚠️ EXPIRED CONTRACTS (FREE AGENCY):",
    "next_year_btn": "🌅 START SEASON {{year}} ➔",
    "reinforcement_title": "GAME 40: SPRING REINFORCEMENT",
    "reinforcement_desc": "Your front office has granted 1 Special Reinforcement Booster Pack to strengthen your roster!",
    "open_reinforcement_pack": "✨ OPEN REINFORCEMENT PACK ➔",
    "replace_player_title": "🔄 SELECT PLAYER TO REPLACE",
    "replace_player_desc": "The selected player will be released from your franchise and the new recruit will join with a 2-year contract.",
    "keep_current_roster": "❌ KEEP CURRENT ROSTER (DISCARD REINFORCEMENT)",
    "replace_btn": "REPLACE",
    "replaced_success": "{{newPlayer}} has joined the roster replacing {{oldPlayer}}!",
    "empty_slot": "[Empty]",
    "selected_franchise_banner": "FRANCHISE: {{team}} ({{league}} {{div}})",
    "roster_forming_title": "📋 ROSTER IN PROGRESS ({{count}}/25)",
    "bat_pitch_count": "{{bat}} Bat • {{pitch}} Pitch",
    "lineup_forming": "⚡ LINEUP (9 STARTERS)",
    "bench_forming": "🛋️ BENCH ({{count}}/4)",
    "rotation_forming": "🧢 ROTATION (5 SP)",
    "bullpen_forming": "🔥 BULLPEN (7 RP)",
    "official_roster_title": "📋 OFFICIAL 25-MAN ROSTER: {{icon}} {{name}}",
    "official_roster_subtitle": "Season {{year}} • Active multi-year contracts",
    "season_header": "⚾ SEASON {{year}}: {{icon}} {{name}}",
    "season_record_summary": "Record: <strong style=\"color:#34d399;\">{{w}}W</strong> - <strong style=\"color:#f87171;\">{{l}}L</strong> • {{league}} {{div}} ({{played}}/162 games) • Rings: 🏆 {{rings}}",
    "day_timeline_start": "DAY 1",
    "day_timeline_40": "DAY 40 (RECRUIT)",
    "day_timeline_81": "DAY 81 (ALL-STAR)",
    "day_timeline_110": "DAY 110 (TRADE DEADLINE)",
    "day_timeline_end": "DAY 162",
    "recent_results_title": "📜 RECENT RESULTS",
    "no_games_yet": "No games played yet.",
    "team_header_col": "TEAM",
    "diff_header_col": "DIFF",
    "batter_stats_header": "⚡ BATTER STATS ({{icon}} {{name}})",
    "pitcher_stats_header": "🧢 PITCHER STATS ({{icon}} {{name}})",
    "no_at_bats": "No plate appearances logged yet.",
    "no_innings_pitched": "No innings pitched yet.",
    "other_teams_title": "🔍 29 OTHER LEAGUE FRANCHISE ROSTERS",
    "ace_label": "Ace",
    "best_bat_label": "Bat",
    "rival_alert_details": "⚾ {{icon}} {{name}}\n\nLineup Leader: {{lineup}}\nAce Starter: {{sp}}\nCloser: {{rp}}\nTotal Players: 25 on active roster.",
    "midseason_allstar_title": "GAME 81: ALL-STAR BREAK",
    "midseason_allstar_desc": "Midway through the regular season! Your squad rests, recharges and gears up for the pennant race.",
    "midseason_allstar_btn": "CONTINUE SECOND HALF ➔",
    "midseason_trade_title": "GAME 110: TRADE DEADLINE",
    "midseason_trade_desc": "Another club offers star <strong>{{name}} (OVR {{ovr}})</strong> for your playoff push.",
    "midseason_trade_question": "Do you want to accept the trade to reinforce your roster for the postseason?",
    "midseason_trade_accept": "🤝 ACCEPT TRADE",
    "midseason_trade_decline": "KEEP ROSTER",
    "spring_booster_title": "SPRING BOOSTER PACK",
    "spring_booster_badge": "FRANCHISE REINFORCEMENT (2 YRS)",
    "spring_booster_open": "✨ TAP TO OPEN REINFORCEMENT ✨",
    "card_career_saves": "SAVES (SV)",
    "card_career_strikeouts": "STRIKEOUTS (K)",
    "card_career_record": "RECORD (W-L)",
    "card_career_innings": "INNINGS (IP)",
    "card_career_hits": "HITS (H)",
    "card_career_homers": "HOME RUNS (HR)",
    "card_career_rbis": "RUNS BATTED IN (RBI)",
    "playoff_won_ws": "🏆 WORLD SERIES CHAMPIONS! Your franchise hoisted the Commissioner's Trophy.",
    "playoff_eliminated": "🥈 Eliminated in the League Championship Series after a fierce Postseason fight.",
    "playoff_missed": "❌ Record {{w}}-{{l}}: Not enough to punch a ticket to October baseball.",
    "offseason_expired_count": "{{count}} players",
    "offseason_expired_desc": "Players whose contracts ended enter free agency. <strong>All players with active contracts remain on your roster!</strong> You will open exactly {{count}} packs to fill the vacancies.",
    "offseason_no_expired": "Outstanding management! No contracts expired this season. Your roster remains fully intact.",
    "tap_open_pack_num": "✨ TAP TO OPEN PACK #{{num}} ✨",
    "rotation_bullpen_pack": "ROTATION & BULLPEN PACK",
    "batter_pack": "MLB ALL-TIME BATTER PACK",
    "year_suffix": "YR",
    "years_suffix": "YRS",
    "leader_hr": "HOME RUNS (HR)",
    "leader_rbi": "RUNS BATTED IN (RBI)",
    "leader_avg": "BATTING AVG (AVG)",
    "leader_k": "STRIKEOUTS (K)",
    "leader_w": "WINS (W)",
    "leader_era": "EARNED RUN AVG (ERA)",
    "contract_multi": "Multi-year franchise deal",
    "contract_mega": "Franchise mega contract!",
    "contract_short": "Short prove-it deal (Bad luck)",
    "contract_surprise": "Surprise long-term commitment!",
    "batting_order_hint": "Batting Order (Drag & drop to reorder)",
    "optimal_order_btn": "⚡ OPTIMAL ORDER",
    "player_details_modal_title": "PLAYER DETAILS & STATS",
    "season_stats_header": "CURRENT SEASON",
    "career_dynasty_stats_header": "DYNASTY CAREER TOTALS",
    "rival_roster_modal_title": "OFFICIAL 25-MAN ROSTER: {{team}}",
    "close": "CLOSE",
    "click_player_hint": "💡 Click any player to view their card and full statistics",
    "btn_resign_player": "✍️ OFFER EXTENSION",
    "btn_already_negotiated": "NEGOTIATED THIS YEAR",
    "resign_modal_title": "CONTRACT EXTENSION OFFER",
    "resign_modal_desc": "Attempt to extend {{name}} (OVR {{ovr}}) before free agency. Players evaluate team performance, their own ratings, and contract length. They may decline or accept.",
    "resign_offer_length": "Contract Length to Offer:",
    "resign_interest_high": "High Interest (85% Chance)",
    "resign_interest_med": "Moderate Interest (55% Chance)",
    "resign_interest_low": "Difficult Negotiation (30% Chance)",
    "resign_submit_btn": "SUBMIT OFFER ➔",
    "resign_success_title": "DEAL REACHED! 🎉",
    "resign_success_desc": "{{name}} is thrilled with the project and signed an extension for {{years}} season(s)!",
  ...
  let currentLang = localStorage.getItem('baserogue_lang') || 'en';
