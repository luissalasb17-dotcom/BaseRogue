    ...
    es: {
      translation: {
        ...
        "eras": {
                ...
                "franchises_header": "⚾ FRANQUICIAS DEL ROSTER",
                "genesis_d1": "30% prob. de avanzar base adicional y +10 daño",
                "genesis_d2": "45% prob. de avanzar base adicional y +20 daño",
                "genesis_d3": "60% prob. de avanzar base adicional y +30 daño",
                "genesis_d4": "80% prob. de avanzar base adicional y +40 daño",
                "deadball_d1": "+10 CON/K-AVD al bateador; sencillos (1B) hacen +15 daño extra",
                "deadball_d2": "+18 CON/K-AVD; sencillos hacen +25 daño extra",
                "deadball_d3": "+26 CON/K-AVD; sencillos +35 daño; carreras anotadas hacen +20 daño extra",
                "deadball_d4": "+35 CON/K-AVD; sencillos +45 daño; carreras anotadas hacen +35 daño extra",
                "golden_d1": "+8 PWR al bateador; todos los hits hacen +15 daño extra",
                "golden_d2": "+15 PWR; hits +25 daño; 40% prob. de convertir 2B en 3B",
                "golden_d3": "+20 PWR; hits +35 daño; 50% de 2B→3B y 25% de 3B→HR",
                "golden_d4": "+30 PWR; hits +45 daño; 60% de 2B→3B y 40% de 3B→HR",
                "integration_d1": "Bateador obtiene +4 a todos sus stats en turno",
                "integration_d2": "Bateador +8 stats; outs curan +5 Stamina a todos",
                "integration_d3": "Bateador +8 stats; outs curan +10 Stamina a todos",
                "integration_d4": "+12 stats; outs curan +15; inmune a pérdida de Stamina",
                "speed_d1": "+10 SPD al bateador; +20% prob. de robo; robo cura +15 Stamina",
                "speed_d2": "+15 SPD y +10 EYE; +35% prob. de robo; robo cura +25 y hace +20 daño",
                "speed_d3": "+20 SPD y +20 EYE; +50% prob. de robo; robo cura +35 y hace +30 daño",
                "speed_d4": "+25 SPD y +25 EYE; robo 100% garantizado; cura +45 y hace +40 daño",
                "astroturf_d1": "+10 DEF y +10 SPD al equipo (+10 Escudo); robos hacen +20 daño",
                "astroturf_d2": "+20 DEF/SPD (+20 Escudo); robos hacen +35 daño y debuff 3 impactos",
                "astroturf_d3": "+30 DEF/SPD (+30 Escudo); robos hacen +45 daño y debuff 4 impactos",
                "astroturf_d4": "+40 DEF/SPD (+40 Escudo); robos +60 daño, debuff 5 impactos y outs hacen -50% daño",
                "steroid_d1": "+10 PWR al bateador; Jonrones (HR) hacen +30 daño adicional",
                "steroid_d2": "+20 PWR; HR hacen +50 daño adicional y curan +15 Stamina a todos",
                "steroid_d3": "+30 PWR; HR hacen +70 daño adicional y curan +25 Stamina a todos",
                "steroid_d4": "+40 PWR; HR hacen +90 daño adicional y curan +40 Stamina a todos",
                ...
                "tto_d1": "+10 EYE y +10 PWR; BB hacen +20 daño; Ponche hace -50% daño al equipo",
                "tto_d2": "+20 EYE/PWR; BB +35 daño; Ponche no incrementa racha enemiga",
                "tto_d3": "+30 EYE/PWR; BB +50 daño; HR aplica debuff de 3 impactos (+30% daño)",
                "tto_d4": "+40 EYE/PWR; BB +65 daño; Ponche hace 0 daño al equipo (anulado)",
    ...
    en: {
      translation: {
        ...
        "eras": {
                "header": "⏳ ROSTER ERAS",
                "franchises_header": "⚾ ROSTER FRANCHISES",
                "genesis_d1": "30% chance to advance extra base and +10 dmg",
                "genesis_d2": "45% chance to advance extra base and +20 dmg",
                "genesis_d3": "60% chance to advance extra base and +30 dmg",
                "genesis_d4": "80% chance to advance extra base and +40 dmg",
                "deadball_d1": "+10 CON/K-AVD to batter; singles (1B) deal +15 extra dmg",
                "deadball_d2": "+18 CON/K-AVD; singles deal +25 extra dmg",
                "deadball_d3": "+26 CON/K-AVD; singles +35 dmg; runs scored deal +20 extra impact dmg",
                "deadball_d4": "+35 CON/K-AVD; singles +45 dmg; runs scored deal +35 extra impact dmg",
                "golden_d1": "+8 PWR to batter; all hits deal +15 extra dmg",
                "golden_d2": "+15 PWR; hits +25 dmg; 40% chance 2B→3B",
                "golden_d3": "+20 PWR; hits +35 dmg; 50% 2B→3B and 25% 3B→HR",
                "golden_d4": "+30 PWR; hits +45 dmg; 60% 2B→3B and 40% 3B→HR",
                "integration_d1": "Batter gains +4 to all stats this turn",
                "integration_d2": "Batter +8 stats; outs restore +5 Stamina to all",
                "integration_d3": "Batter +8 stats; outs restore +10 Stamina to all",
                "integration_d4": "+12 stats; outs restore +15; immune to Stamina loss",
                "speed_d1": "+10 SPD to batter; +20% steal chance; steal heals +15 Stamina",
                "speed_d2": "+15 SPD & +10 EYE; +35% steal chance; steal heals +25 and deals +20 dmg",
                "speed_d3": "+20 SPD & +20 EYE; +50% steal chance; steal heals +35 and deals +30 dmg",
                "speed_d4": "+25 SPD & +25 EYE; 100% guaranteed steal; heals +45 and deals +40 dmg",
                "astroturf_d1": "+10 DEF and +10 SPD to team (+10 Shield); steals deal +20 dmg",
                "astroturf_d2": "+20 DEF/SPD (+20 Shield); steals deal +35 dmg & 3-impact debuff",
                "astroturf_d3": "+30 DEF/SPD (+30 Shield); steals deal +45 dmg & 4-impact debuff",
                "astroturf_d4": "+40 DEF/SPD (+40 Shield); steals +60 dmg, 5-impact debuff & outs deal -50% dmg",
                "steroid_d1": "+10 PWR to batter; Home Runs (HR) deal +30 additional dmg",
                "steroid_d2": "+20 PWR; HR deal +50 additional dmg and heal +15 Stamina to all",
                "steroid_d3": "+30 PWR; HR deal +70 additional dmg and heal +25 Stamina to all",
                "steroid_d4": "+40 PWR; HR deal +90 additional dmg and heal +40 Stamina to all",
                ...
                "tto_d1": "+10 EYE and +10 PWR; BB deal +20 dmg; Strikeout deals -50% team dmg",
                "tto_d2": "+20 EYE/PWR; BB +35 dmg; Strikeouts don't grow enemy streak",
                "tto_d3": "+30 EYE/PWR; BB +50 dmg; HR inflicts 3-impact debuff (+30% dmg)",
                "tto_d4": "+40 EYE/PWR; BB +65 dmg; Strikeouts deal 0 damage to team (nullified)",
