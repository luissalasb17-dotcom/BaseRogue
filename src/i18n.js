(function () {
  ...
  const locales = {
    ...
    "combat_info": {
        ...
        "steal": "<strong style=\"color: #38bdf8;\">🏃 BASE STEALING:</strong><div style=\"font-size: 8.5px; color: #cbd5e1; margin-top: 2px;\">• <strong>2B (on 1B/BB, SPD ≥ 40):</strong> Success based on SPD (40-100%).<br>• <strong>3B (on 2B, SPD ≥ 50):</strong> Success based on SPD/2 (25-50%).<br><em>Stealing debuffs pitcher (+20% damage for 2 hits).</em></div>",
