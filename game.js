  ...
  class GameState {
    ...
    getZoneConfig(zoneIdx) {
      const zones = [
        {
          id: 0,
          name: "Spring Training & Opening Month",
          nameKey: "map.zone_opening",
          subtitleKey: "map.stage_opening",
          subtitle: "Abril: Inicio de temporada - Dificultad: Normal",
          theme: "zone-minor",
        ...
        {
          id: 1,
          name: "Summer Grind & All-Star Break",
          nameKey: "map.zone_allstar",
          subtitleKey: "map.stage_allstar",
          subtitle: "Junio–Julio: Mitad de temporada - Dificultad: Difícil",
          theme: "zone-major",
        ...
        {
          id: 2,
          name: "September Pennant Chase",
          nameKey: "map.zone_pennant",
          subtitleKey: "map.stage_pennant",
          subtitle: "Septiembre: Recta final - Dificultad: Experto",
          theme: "zone-pennant",
        ...
        {
          id: 3,
          name: "Postseason: World Series",
          nameKey: "map.zone_playoffs",
          subtitleKey: "map.stage_playoffs",
          subtitle: "Octubre: Fase final - Dificultad: Leyenda",
          theme: "zone-hof",
