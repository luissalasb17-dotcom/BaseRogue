...
(function() {
  ...
  class GameState {
    ...
    getDraftRoundInfo() {
      ...
      if (r === 3) return { label: 'RARO GARANTIZADO', labelKey: 'draft.round_3_label', rarities: ['Rare'], icon: '🔵' };
      if (r === 4) return { label: 'POCO COMÚN GARANTIZADO', labelKey: 'draft.round_4_label', rarities: ['Uncommon'], icon: '🟢' };
